        ...
        <div className='w-full  flex-col justify-center md:flex-row flex '>
          <div style={{ backgroundColor: "#ebeaeb" }} className='md:w-5/12 pt-10 md:pt-0 w-full'>
            ...
            {sw && <div >
              ...
              <AppWithZoomCustomization image={!wood ? product.variants[selectedcolor].img[index] : type == "35mm" ? data[selectedcolor].img[index] : data1[selectedcolor].img[index]} />
            ...
            {!sw &&
              <div>
                ...
                <div >{!wood ? <img src={product.variants[selectedcolor].img[index]} className="p-[3vh]"></img> : type == "35mm" ? <img src={data[selectedcolor].img[index]} className=" scale-75"></img> : <img src={data1[selectedcolor].img[index]} className=" scale-75"></img>}</div>
            ...
            <div className='flex flex-col '>
              ...
              <div style={sw ? { padding: "0vw 2.5vw", marginBottom: "1.875vw" } : { padding: "0vh 2.5vh", marginBottom: "1.875vh" }} className="  w-full px-8 mb-6 bg-white  ">
                ...
                <div style={sw ? { marginTop: "1.875vw 0vw", paddingTop: "1.6vw" } : { marginTop: "1.875vh 0vw", paddingTop: "1.6vh" }} className="flex flex-col md:flex-row justify-between md:items-center  pt-5">
                  <div style={sw ? { fontSize: "1.25vw" } : { fontSize: "1.5vh" }}> Your Price : 0
                  ...
                  <>
                    ...
                    <Disclosure.Panel style={sw ? { padding: "0.625vw 2.1875vw 2.5vw" } : { padding: "0.625vh 2.1875vh 2.5vh" }} className=" pt-2 pb-8  text-gray-500 flex flex-col px-7 bg-white">
                      ...
                      <div className='md:max-h-[31vw] w-full max-h-36 overflow-y-auto overflow-x-hidden'>
                        {withmotor && Object.keys(recomendedmotors).map((m) => {
                          return <><div id={recomendedmotors[m].slug} style={sw ? { fontFamily: "'lato',san-serif", borderColor: "#bfb1c4", height: "17vw", marginRight: "1.875vw", marginTop: "2vw", padding: "0.5vw" } : { fontFamily: "'lato',san-serif", borderColor: "#bfb1c4", height: "17vh", marginRight: "1.875vh", marginTop: "2vh", padding: "0.5vh" }} className='flex btn w-full border-2  ' key={m}>
